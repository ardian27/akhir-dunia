...
public class SimpleGetPengujian extends AppCompatActivity {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    Intent next = new Intent(SimpleGetPengujian.this , SimpleConvertPengujian.class);
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    Toast.makeText(SimpleGetPengujian.this, "Image Saved!", Toast.LENGTH_SHORT).show();
                    ...
                    e.printStackTrace();
                    Toast.makeText(SimpleGetPengujian.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
