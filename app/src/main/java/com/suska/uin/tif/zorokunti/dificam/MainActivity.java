...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_pengguna) {
            ...
            Intent pelatihan= new Intent(MainActivity.this , PelatihanActivity.class);
            startActivity(pelatihan);
            ...
            Intent lbp= new Intent(MainActivity.this , LbpActivity.class);
            startActivity(lbp);

        } else if (id == R.id.nav_bpnn) {
            Intent bpnn= new Intent(MainActivity.this , BpnnActivity.class);
            startActivity(bpnn);
