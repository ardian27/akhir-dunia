...
public class GetPictActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_pict);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    Intent next = new Intent(GetPictActivity.this , ConvertPictureActivity.class);
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    Toast.makeText(GetPictActivity.this, "Image Saved!", Toast.LENGTH_SHORT).show();
                    ...
                    e.printStackTrace();
                    Toast.makeText(GetPictActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
